...
/* ============================================================
   ...
   ============================================================ */
DECLARE @appId INT, @candidateId INT, @recruiterId INT, @jobTitle NVARCHAR(255);
...
IF @appId IS NULL
BEGIN
    PRINT N'Không tìm thấy application APPROVED nào (chưa có interview).';
END
ELSE
BEGIN
    ...
    VALUES
        (@appId, @recruiterId, @candidateId,
         DATEADD(DAY, 3, GETDATE()),                    -- lịch sau 3 ngày (>= 24h)
