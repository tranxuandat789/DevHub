...
-- -------------------------------------------------------------
-- 2. COMPANY PROFILES (hồ sơ công ty đầy đủ, is_verified=1)
-- -------------------------------------------------------------
...
VALUES (
    ...
    (
        ...
        N'KMS Technology',
        N'Hồ Chí Minh',
        N'Công ty phát triển phần mềm toàn cầu với 100% khách hàng tại thị trường Mỹ và Châu Âu.',
    ...
    (
        ...
        N'Axon Active',
        N'Đà Nẵng',
        N'Tập đoàn phần mềm Thụy Sĩ, môi trường làm việc Agile/Scrum chuyên nghiệp.',
        'https://axon-active.com',
        N'Phần mềm',
        '0405111222',
        0.00,
        0,
    ...
    (
        ...
        N'Sky Mavis',
        N'Hồ Chí Minh',
        N'Kỳ lân công nghệ Việt Nam, cha đẻ của game Axie Infinity nổi tiếng toàn cầu.',
        'https://skymavis.com',
        N'Blockchain & Game',
        '0311555666',
        0.00,
    ...
    (
        ...
        N'ZaloPay',
        N'Hồ Chí Minh',
        N'Ví điện tử ZaloPay – ứng dụng thanh toán quốc dân trực thuộc VNG Corporation.',
        'https://zalopay.vn',
        N'Fintech',
        '0307777888',
        0.00,
    ...
    (
        ...
        N'Base.vn',
        N'Hà Nội',
        N'Nền tảng quản trị doanh nghiệp SaaS hàng đầu, tự hào là sản phẩm công nghệ Make in Vietnam.',
        'https://base.vn',
        N'B2B SaaS',
        '0109999000',
        0.00,
...
VALUES -- ===== TPBank (23) =====
    (
        23,
        1,
        N'Senior Java Backend Engineer',
    ...
    (
        23,
        18,
        N'Data Engineer – Fintech Analytics',
    ...
    (
        23,
        4,
        N'Fullstack Developer – Mobile Banking',
        ...
        N'React Native, TypeScript, REST API',
        N'Mid',
        N'Hybrid',
        18000000,
        28000000,
    ...
    (
        24,
        3,
        N'Senior Frontend Developer – MoMo Super App',
    ...
    (
        25,
        3,
        N'Frontend Developer – React/NextJS',
    ...
    (
        25,
        1,
        N'Backend Developer – Python/Django',
    ...
    (
        26,
        1,
        N'Backend Engineer – Go/Microservices',
    ...
    (
        26,
        20,
        N'UI/UX Designer – EdTech Product',
    ...
    (
        27,
        1,
        N'Senior Backend Engineer – E-Commerce Platform',
    ...
    (
        27,
        18,
        N'Data Analyst – E-Commerce Insights',
    ...
    (
        27,
        5,
        N'Mobile Developer – Tiki App (iOS/Android)',
        ...
        N'React Native, Flutter, TypeScript',
        N'Mid',
        N'Full-time',
        20000000,
        35000000,
    ...
    (
        28,
        1,
        N'.NET Core Developer – US Market',
    ...
    (
        29,
        4,
        N'Fullstack Developer – Java/Angular',
    ...
    (
        29,
        11,
        N'QA Engineer – Manual & Automation',
        ...
        N'Manual Testing, Selenium, Jira',
        N'Junior/Mid',
        N'Full-time',
        14000000,
        22000000,
    ...
    (
        30,
        1,
        N'Senior Backend Engineer – Blockchain',
    ...
    (
        30,
        20,
        N'UI/UX Designer – Game & NFT Marketplace',
    ...
    (
        31,
        1,
        N'Senior Backend Developer – Payment Core',
    ...
    (
        31,
        19,
        N'Data Scientist – Fraud Detection',
    ...
    (
        32,
        3,
        N'Frontend Developer – SaaS Platform',
    ...
    (
        32,
        1,
        N'Backend Developer – Node.js/NestJS',
...
-- -------------------------------------------------------------
-- 3.1 INSERT MAPPING SANG BẢNG job_post_province
-- Mỗi công ty trong đợt seed này đều có chung địa điểm cho tất cả job
-- -------------------------------------------------------------
INSERT INTO dbo.job_post_province (job_id, province_id)
SELECT j.JobId,
    p.province_id
FROM @Jobs j
    JOIN dbo.job_post jp ON jp.job_id = j.JobId
    JOIN dbo.company c ON c.company_id = jp.company_id
    JOIN dbo.province p ON p.province_name = c.company_address;
-- -------------------------------------------------------------
...
DECLARE @JobId INT;
DECLARE @RecId INT;
WHILE @RowNum <= @TotalJobs BEGIN
SELECT @JobId = JobId
FROM @Jobs
WHERE RowNum = @RowNum;
-- Nhóm theo RowNum để biết thuộc công ty nào (3 job/công ty)
DECLARE @GroupIdx INT = ((@RowNum - 1) / 3) + 1;
-- 1..10 tương ứng 10 công ty
DECLARE @JobInGroup INT = ((@RowNum - 1) % 3) + 1;
-- 1..3 trong mỗi nhóm
IF @GroupIdx = 1 -- TPBank
BEGIN IF @JobInGroup = 1
INSERT INTO dbo.job_tech_stack
VALUES (@JobId, 1),
    (@JobId, 2),
    (@JobId, 13);
-- Java, Spring Boot, Docker
ELSE IF @JobInGroup = 2
INSERT INTO dbo.job_tech_stack
VALUES (@JobId, 5),
    (@JobId, 18),
    (@JobId, 30);
...
VALUES (@JobId, 32),
    (@JobId, 30),
    (@JobId, 17);
-- Business Analyst, SQL, SQL Server
END
SET @RowNum = @RowNum + 1;
END;
-- -------------------------------------------------------------
...
-- Unique constraint: (candidate_id, company_id) không trùng
-- -------------------------------------------------------------
INSERT INTO dbo.review_company (
        candidate_id,
        company_id,
        rating,
        pros,
...
VALUES -- TPBank (23)
    (
        ...
        23,
        5,
        N'Văn hóa học hỏi cao, đồng nghiệp xuất sắc',
        N'Deadline đôi khi gấp',
        N'Môi trường làm việc chuyên nghiệp, sếp hỗ trợ tốt.',
        0,
        'APPROVED',
        8,
        GETDATE(),
    ...
    (
        ...
        23,
        4,
        N'Lương cạnh tranh, văn phòng hiện đại',
        N'Cần cải thiện quy trình onboarding',
        N'Đội ngũ kỹ thuật giỏi, nhiều cơ hội phát triển bản thân.',
        0,
        'APPROVED',
        8,
        GETDATE(),
    ...
    (
        ...
        23,
        4,
        N'Phúc lợi tốt, công việc thú vị',
        N'Áp lực fintech khá cao',
        N'Tốt cho người muốn học công nghệ ngân hàng.',
        1,
        'APPROVED',
        8,
        GETDATE(),
    ...
    (
        ...
        24,
        5,
        N'Sản phẩm tác động hàng triệu người, team tài năng',
        N'Work-life balance đôi khi chưa tốt',
        N'Công ty startup có văn hóa năng động, học hỏi rất nhiều.',
        0,
        'APPROVED',
        8,
        GETDATE(),
    ...
    (
        ...
        24,
        5,
        N'ESOP hấp dẫn, đồng nghiệp xuất sắc',
        N'Cần adapt nhanh với tốc độ thay đổi',
        N'MoMo có team engineering rất chất lượng.',
        0,
        'APPROVED',
        8,
        GETDATE(),
    ...
    (
        ...
        25,
        4,
        N'Làm sản phẩm HR ý nghĩa, team thân thiện',
        N'Lương mid-range so với thị trường',
        N'Phù hợp nếu bạn muốn trải nghiệm startup HR Tech.',
        0,
        'APPROVED',
        8,
        GETDATE(),
    ...
    (
        ...
        25,
        3,
        N'Môi trường học hỏi, đồng nghiệp nice',
        N'Quy trình review lương còn chậm',
        N'Startup tốt nhưng cần cải thiện comp & benefit.',
        1,
        'APPROVED',
        8,
        GETDATE(),
    ...
    (
        ...
        26,
        5,
        N'Làm việc với AI/LLM cutting-edge, đội ngũ PhD',
        N'Interview khó, bar cao',
        N'Tốt nhất cho người yêu AI và muốn nghiên cứu sâu.',
        0,
        'APPROVED',
        8,
        GETDATE(),
    ...
    (
        ...
        26,
        4,
        N'Remote linh hoạt, team quốc tế',
        N'Deadline khắt khe',
        N'Got It có culture R&D rất tốt cho kỹ sư senior.',
        0,
        'APPROVED',
        8,
        GETDATE(),
    ...
    (
        ...
        27,
        4,
        N'Scale lớn, bài toán kỹ thuật thú vị',
        N'OT nhiều trong mùa sale lớn',
        N'Làm việc với traffic khổng lồ rất tốt cho portfolio.',
        0,
        'APPROVED',
        8,
        GETDATE(),
    ...
    (
        ...
        27,
        4,
        N'ESOP, bảo hiểm toàn gia đình',
        N'Áp lực KPI cao',
        N'Phúc lợi tốt, môi trường cạnh tranh.',
        1,
        'APPROVED',
        8,
        GETDATE(),
    ...
    (
        ...
        27,
        5,
        N'Bài toán data phong phú, sản phẩm thực tế',
        N'Cần kinh nghiệm distributed systems',
        N'Tiki là môi trường lý tưởng cho data engineer muốn scale.',
        0,
        'APPROVED',
        8,
        GETDATE(),
    ...
    (
        ...
        28,
        4,
        N'Cơ hội onsite nước ngoài, môi trường chuyên nghiệp',
        N'Thời gian cố định theo giờ Mỹ',
        N'KMS có process tốt và khách hàng uy tín.',
        0,
        'APPROVED',
        8,
        GETDATE(),
    ...
    (
        ...
        28,
        3,
        N'Không OT, công việc ổn định',
        N'Tech stack đôi khi cũ',
        N'Phù hợp người cần ổn định hơn là startup fast-pace.',
        1,
        'APPROVED',
        8,
        GETDATE(),
    ...
    (
        ...
        29,
        5,
        N'Onsite Thụy Sĩ, đội ngũ châu Âu chuyên nghiệp',
        N'Cần tiếng Anh thật tốt',
        N'Axon Active cho trải nghiệm làm việc quốc tế thực sự.',
        0,
        'APPROVED',
        8,
        GETDATE(),
    ...
    (
        ...
        29,
        4,
        N'Agile thực sự, không chỉ lý thuyết',
        N'Khách hàng remote đôi khi khó align',
        N'Môi trường outsourcing chất lượng cao ít gặp ở VN.',
        0,
        'APPROVED',
        8,
        GETDATE(),
    ...
    (
        ...
        30,
        5,
        N'Sản phẩm tác động toàn cầu, token thưởng',
        N'Crypto market volatile ảnh hưởng mood',
        N'Sky Mavis cho cảm giác làm việc với sản phẩm thế giới thực.',
        0,
        'APPROVED',
        8,
        GETDATE(),
    ...
    (
        ...
        30,
        5,
        N'Team game developer đỉnh nhất Đông Nam Á',
        N'Không phù hợp người không thích game/Web3',
        N'Đây là nơi tốt nhất để học blockchain engineering tại VN.',
        0,
        'APPROVED',
        8,
        GETDATE(),
    ...
    (
        ...
        31,
        5,
        N'Thu nhập top đầu thị trường, fintech scale lớn',
        N'Áp lực hệ thống payment cao',
        N'ZaloPay trả rất tốt và bài toán kỹ thuật cực kỳ thú vị.',
        0,
        'APPROVED',
        8,
        GETDATE(),
    ...
    (
        ...
        31,
        4,
        N'Bảo hiểm premium, văn phòng trung tâm HCM',
        N'OT trong các đợt triển khai feature lớn',
        N'Phúc lợi rất tốt, nên apply nếu bạn giỏi backend.',
        1,
        'APPROVED',
        8,
        GETDATE(),
    ...
    (
        ...
        32,
        4,
        N'Sản phẩm thuần Việt ý nghĩa, team SaaS chuyên nghiệp',
        N'Lương chưa bằng fintech/game',
        N'Base.vn tốt cho bạn muốn xây SaaS B2B từ đầu đến cuối.',
        0,
        'APPROVED',
        8,
        GETDATE(),
    ...
    (
        ...
        32,
        3,
        N'Không OT, môi trường cân bằng',
        N'Tốc độ phát triển hơi chậm so với startup khác',
        N'Phù hợp nếu bạn ưu tiên work-life balance.',
        1,
        'APPROVED',
        8,
        GETDATE(),
    ...
    (
        ...
        23,
        5,
        N'Core banking thú vị, đồng nghiệp senior rất giỏi',
        N'Onboarding dài',
        N'TPBank đầu tư mạnh vào công nghệ, phù hợp backend senior.',
        0,
        'APPROVED',
        8,
        GETDATE(),
    ...
    (
        ...
        24,
        4,
        N'Văn hóa open, nhiều sự kiện nội bộ',
        N'Yêu cầu cao, bar tuyển dụng khó',
        N'MoMo tốt cho người muốn làm ở công ty product lớn.',
        0,
        'APPROVED',
        8,
        GETDATE(),
...
-- -------------------------------------------------------------
UPDATE r
SET r.average_rating = CAST(agg.avg_rating AS DECIMAL(3, 2)),
