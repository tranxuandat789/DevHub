...
CREATE UNIQUE NONCLUSTERED INDEX UQ_user_google_id 
...
CREATE TABLE [candidate] (
    ...
    CONSTRAINT [FK__candidate__candi] FOREIGN KEY ([candidate_id]) 
        REFERENCES [user_account]([user_id]) ON DELETE NO ACTION
);
...
CREATE TABLE [recruiter] (
    ...
    [profile_completion] INT DEFAULT 0,
    CONSTRAINT [FK__recruiter__recru] FOREIGN KEY ([recruiter_id]) 
        REFERENCES [user_account]([user_id]) ON DELETE NO ACTION
);
...
CREATE TABLE [cv] (
    ...
    CONSTRAINT [FK__cv__candidate_id] FOREIGN KEY ([candidate_id]) 
...
CREATE TABLE [candidate_skill] (
    ...
    CONSTRAINT [FK__candidate_skill__candidate] FOREIGN KEY ([candidate_id]) 
        REFERENCES [candidate]([candidate_id]) ON DELETE CASCADE,
    CONSTRAINT [FK__candidate_skill__tech] FOREIGN KEY ([tech_id]) 
        REFERENCES [common_technology]([tech_id]) ON DELETE CASCADE
);
...
CREATE TABLE [package_transaction] (
    ...
    CONSTRAINT [FK__package_transaction__recruiter] FOREIGN KEY ([recruiter_id]) 
        REFERENCES [recruiter]([recruiter_id]) ON DELETE CASCADE,
    CONSTRAINT [FK__package_transaction__service] FOREIGN KEY ([service_id]) 
        REFERENCES [service_package]([service_id]),
    CONSTRAINT [FK__package_transaction__promotion] FOREIGN KEY ([promotion_id]) 
        REFERENCES [promotion]([promotion_id])
);

-- Create Package Transaction Indexes
CREATE NONCLUSTERED INDEX [idx_payment_recruiter] ON [package_transaction]([recruiter_id]);
...
-- =====================================================
-- Create Recruiter Package History Table
-- =====================================================
CREATE TABLE [recruiter_package_history] (
    ...
    CONSTRAINT [FK__recruiter_history__recruiter] FOREIGN KEY ([recruiter_id]) 
        REFERENCES [recruiter]([recruiter_id]) ON DELETE CASCADE,
    CONSTRAINT [FK__recruiter_history__service] FOREIGN KEY ([service_id]) 
        REFERENCES [service_package]([service_id]) ON DELETE CASCADE,
    CONSTRAINT [FK__recruiter_history__transaction] FOREIGN KEY ([transaction_id]) 
        REFERENCES [package_transaction]([transaction_id]) ON DELETE NO ACTION
);
...
CREATE TABLE [job_post] (
    ...
    [recruiter_package_history_id] INT,
    ...
    [created_at] DATETIME DEFAULT GETDATE(),
    CONSTRAINT [FK__job_post__position] FOREIGN KEY ([position_id]) 
        REFERENCES [common_job_position]([position_id]) ON DELETE CASCADE,
    CONSTRAINT [FK__job_post__recruiter] FOREIGN KEY ([recruiter_id]) 
        REFERENCES [recruiter]([recruiter_id]),
    CONSTRAINT [FK__job_post__moderator] FOREIGN KEY ([moderator_id]) 
        REFERENCES [admin]([admin_id]),
    CONSTRAINT [FK__job_post__package_history] FOREIGN KEY ([recruiter_package_history_id]) 
        REFERENCES [recruiter_package_history]([id]) ON DELETE NO ACTION
);

-- Create indexes for job_post
CREATE NONCLUSTERED INDEX [idx_job_post_recruiter] ON [job_post]([recruiter_id]);
...
CREATE TABLE [job_tech_stack] (
    ...
    CONSTRAINT [FK__job_tech_stack__job] FOREIGN KEY ([job_id]) 
        REFERENCES [job_post]([job_id]) ON DELETE CASCADE,
    CONSTRAINT [FK__job_tech_stack__tech] FOREIGN KEY ([tech_id]) 
        REFERENCES [common_technology]([tech_id]) ON DELETE CASCADE
);
...
CREATE TABLE [application] (
    ...
    CONSTRAINT [FK__application__job] FOREIGN KEY ([job_id]) 
        REFERENCES [job_post]([job_id]) ON DELETE CASCADE,
    CONSTRAINT [FK__application__candidate] FOREIGN KEY ([candidate_id]) 
        REFERENCES [candidate]([candidate_id]) ON DELETE NO ACTION,
    CONSTRAINT [FK__application__cv] FOREIGN KEY ([cv_id]) 
        REFERENCES [cv]([cv_id]) ON DELETE NO ACTION
);
...
CREATE TABLE [interview] (
    ...
    CONSTRAINT [FK__interview__candidate] FOREIGN KEY ([candidate_id]) 
        REFERENCES [candidate]([candidate_id]) ON DELETE NO ACTION,
    CONSTRAINT [FK__interview__recruiter] FOREIGN KEY ([recruiter_id]) 
        REFERENCES [recruiter]([recruiter_id]) ON DELETE NO ACTION
);
...
CREATE TABLE [bookmark] (
    ...
    [job_id] INT NOT NULL,
    [created_at] DATETIME DEFAULT GETDATE(),
    CONSTRAINT [FK__bookmark__candidate] FOREIGN KEY ([candidate_id]) 
        REFERENCES [candidate]([candidate_id]) ON DELETE CASCADE,
    CONSTRAINT [FK__bookmark__job] FOREIGN KEY ([job_id]) 
        REFERENCES [job_post]([job_id]) ON DELETE CASCADE
);

-- =====================================================
-- Create Review Recruiter Table
-- =====================================================
CREATE TABLE [review_recruiter] (
    ...
    CONSTRAINT [UQ_candidate_recruiter_review] UNIQUE ([candidate_id], [recruiter_id]),
    CONSTRAINT [FK__review_recruiter__candidate] FOREIGN KEY ([candidate_id]) 
        REFERENCES [candidate]([candidate_id]) ON DELETE CASCADE,
    CONSTRAINT [FK__review_recruiter__recruiter] FOREIGN KEY ([recruiter_id]) 
        REFERENCES [recruiter]([recruiter_id]) ON DELETE CASCADE,
    CONSTRAINT [FK__review_recruiter__moderator] FOREIGN KEY ([moderator_id]) 
...
CREATE TABLE [blog_post] (
    ...
    CONSTRAINT [FK__blog_post__publisher] FOREIGN KEY ([publisher_id]) 
        REFERENCES [admin]([admin_id]) ON DELETE CASCADE,
    CONSTRAINT [FK__blog_post__author] FOREIGN KEY ([author_id]) 
