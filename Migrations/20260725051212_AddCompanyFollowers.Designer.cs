...
namespace DevHub.Migrations
{
    ...
    [Migration("20260725051212_AddCompanyFollowers")]
    partial class AddCompanyFollowers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DevHub.Models.CompanyFollower", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DevHub.Models.CompanyInvitation", b =>
                {
                    ...
                    b.ToTable("company_invitation", (string)null);
                });
            ...
            modelBuilder.Entity("DevHub.Models.CompanyPackageHistory", b =>
                {
                    ...
                    b.ToTable("company_package_history", (string)null);
                });
            ...
            modelBuilder.Entity("DevHub.Models.JobPost", b =>
                {
                    ...
                    b.Property<int?>("CompanyPackageHistoryId")
                        .HasColumnType("int")
                        .HasColumnName("company_package_history_id");
                    ...
                    b.HasIndex(new[] { "CompanyId" }, "idx_job_post_company");
            ...
            modelBuilder.Entity("DevHub.Models.ModTierAssignment", b =>
                {
            ...
            modelBuilder.Entity("DevHub.Models.ModeratorIndustryAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex(new[] { "TaskType", "Industry" }, "IX_mod_industry_task_industry")
                        .IsUnique();

                    b.ToTable("moderator_industry_assignment", (string)null);
                });
            ...
            modelBuilder.Entity("DevHub.Models.Province", b =>
                {
                    ...
                    b.HasIndex(new[] { "ProvinceName" }, "UQ_province_name")
                        .IsUnique();
            ...
            modelBuilder.Entity("DevHub.Models.ReviewCompany", b =>
                {
                    ...
                    b.HasIndex(new[] { "CandidateId", "CompanyId" }, "UQ_candidate_company_review")
                        .IsUnique();

                    b.ToTable("review_company", (string)null);
                });
            ...
            modelBuilder.Entity("JobPostProvince", b =>
                {
                    b.Property<int>("JobId")
                        .HasColumnType("int")
                        .HasColumnName("job_id");
                    ...
                    b.HasKey("JobId", "ProvinceId")
                        .HasName("PK_job_post_province");

                    b.HasIndex(new[] { "ProvinceId" }, "idx_job_post_province_province");

                    b.ToTable("job_post_province", (string)null);
                });
            ...
            modelBuilder.Entity("JobPostProvince", b =>
                {
                    ...
                    b.HasOne("DevHub.Models.Province", null)
                        .WithMany()
