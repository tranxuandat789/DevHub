...
{
    Task<(List<JobPost> Items, int TotalCount)> GetModeratorJobPostsAsync(int moderatorId, DateTime? fromDate, DateTime? toDate, string? sortOrder, int page, int pageSize);
